...
export default function About({ darkShit }) {
  return (
    <div className='flex h-full justify-center items-center'>
      ...
      <div className=''>
        <div className='absolute flex-row flex items-center lg:px-1 md:px-0 px-5 w-[360px] md:w-[700px] lg:w-[1100px] justify-between'>
        ...
        <div className='items-center flex flex-col'>
          <p className='text-center px-5 pt-10 lg:text-2xl md:text-xl text-md'>Hello, we are Mary & Maurizio,
